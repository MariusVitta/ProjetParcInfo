    ...
    <x-app-layout>
        ...
        <x-slot name="header_content">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item"><a href="#">logiciel</a></div>
                <div class="breadcrumb-item"><a href="{{ route('Logiciel.lister') }}">  Liste logiciel</a></div>
            </div>
        </x-slot>
        <br>
                    ...
                    <tr>
                        ...
                        @foreach ($logiciels as $logiciel)
                            <tr>
                                ...
                                <td>
                                    <button id="show" type="button" data-toggle="modal" data-target="#modalShow" data-id="{{$logiciel->id}}">
                                        <i class="fa fa-eye text-success  fa-lg"></i>  
                                    </button>
                    
                                    <button id="edit" type="button" data-toggle="modal" data-target="#modalEdit" data-id={{$logiciel->id}}>
                    ...
                    <script type="text/javascript">
                        $(document).ready(function(){
                            ...
                            $('#modalShow').on('shown.bs.modal', function(event){
                                ...
                                $(".select-salles").prop("disabled", true);
                            });
