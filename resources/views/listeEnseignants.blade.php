<x-app-layout>
        <x-slot name="header_content">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item"><a href="">Données Enseignants</a></div>
            </div>
        </x-slot>
        ...
        <div class="row">
            ...
            <table id="tab" class="sortable table table-bordered table-responsive-lg bg-white overflow-hidden shadow-xl sm:rounded-lg sortable">
            <tr>
                <th>Nom</th>
                <th>Prénom</th>
                <th>Statut</th>
            ...
            @foreach ($enseignants as $enseignant)
                <tr>
                    ...
                    <td>
                        <button id="show" type="button" data-toggle="modal" data-target="#modalShow" data-id="{{$enseignant->id}}"  style="border: none; background-color:transparent;">
                            <i class="fa fa-eye text-success  fa-lg"></i>
                        </button>

                        <button id="edit" type="button" data-toggle="modal" data-target="#modalEdit" data-id="{{$enseignant->id}}"  style="border: none; background-color:transparent;">
        ...
        <script type="text/javascript">
            ...
            $('#search').on('keyup',function(event){
                ...
                for (i = 0; i < tr.length; i++) {
                    prenom = tr[i].getElementsByTagName("td")[1];
                    nom = tr[i].getElementsByTagName("td")[0];
                    if (prenom) {
                        txtValue = prenom.textContent || prenom.innerText;
                        if (txtValue.toUpperCase().indexOf(filter) > -1) {
                            tr[i].style.display = "";
                        } else {
                            txtValue = nom.textContent || nom.innerText;
                            if (txtValue.toUpperCase().indexOf(filter) > -1) {
                                tr[i].style.display = "";
                            } else {
