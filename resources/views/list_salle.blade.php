<x-app-layout>
    ...
    <x-slot name="header_content">
        ...
        <div class="section-header-breadcrumb">
            ...
            <div class="breadcrumb-item"><a href="{{ route('salle.lister') }}">  Liste salle</a></div>
        </div>
    </x-slot>
    <br>
        ...
        @foreach ($salles as $salle)
            <tr>
                ...
                <td>
                    ...
                    <button id="show" type="button" data-toggle="modal" data-target="#modalShow" >
                        <i class="fa fa-eye text-success  fa-lg"></i>  
                    </button>

                    <button id="edit" type="button" data-toggle="modal" data-target="#modalEdit" >
