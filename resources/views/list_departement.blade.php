            ...
            <div class="py-12">
                ...
                @foreach ($departements as $departement)
                    <tr>
                        ...
                        <td>
                            <button id="show" type="button" data-toggle="modal" data-target="#modalShow" data-id="{{$departement->id}}">
                                <!-- -->
                                <i class="fa fa-eye text-success  fa-lg"></i>
                                <!-- </a>  -->
                            </button>

                            <button id="edit" type="button" data-toggle="modal" data-target="#modalEdit" data-id="{{$departement->id}}">
